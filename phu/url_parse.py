...
submenu = driver.find_element(By.XPATH,'//*[@id="header"]/div/div[3]/div/div[1]/ul/li[8]/a')
submenu_name = submenu.text
submenu.click()
time.sleep(1)

#자본시장_금융 div[1]/a[1], 자본시장_일반 div[1]/a[5], 지역_공지 div[8]/a[8]
element = driver.find_element(By.XPATH, '/html/body/div/div[1]/div/div[3]/div/div[2]/div[8]/a[8]')
