...
for idx, row in df.iterrows():
    ...
    keyword1_trans = row.iloc[11]
    keyword2_trans = row.iloc[12]
    keyword3_trans = row.iloc[13]
    keyword4_trans = row.iloc[14]
    keyword5_trans = row.iloc[15]
...
# print(result)
df_new.to_csv('output.csv', index=False, encoding='utf-8-sig')
